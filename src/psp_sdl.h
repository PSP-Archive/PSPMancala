...
# define PSP_SDL_SCREEN_HEIGHT   272
  ...
  extern void psp_sdl_back3_rectangle(int x, int y, int w, int h);
  ...
  extern void psp_sdl_blit_board();
  extern void psp_sdl_blit_stone_xy(int x, int y, int num_stones);
  extern void psp_sdl_back2_print(int x,int y,const char *str, int color);
  extern void psp_sdl_back3_print(int x,int y,const char *str, int color);
  extern void psp_sdl_exit(int status);
  extern void psp_sdl_put_pixel(int x, int y, int color);
  extern void psp_sdl_blit_arrow_xy(int x, int y, int arrow);
