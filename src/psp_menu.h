...
# define PSP_MENU_WARNING_COLOR    psp_sdl_rgb(0xFF,0xFF,0xFF)
...
# define PSP_MENU_NORTH_COLOR      psp_sdl_rgb(0xFF,0xFF,0xFF)
# define PSP_MENU_SOUTH_COLOR      psp_sdl_rgb(0x00,0xF0,0xF0)
...
# define PSP_MENU_HELP_COLOR       psp_sdl_rgb(0x00,0xff,0xff)
